...
class Duty(QWidget):
    def __init__(self):
        ...
        self.modify_btn = QPushButton(self)
    ...
    def init_ui(self):
        ...
        ################
        self.modify_btn.setGeometry(QRect(40,410,60,30))
        self.modify_btn.setText("修改")
        self.modify_btn.clicked.connect(self.modify)

        ################
        self.reset_btn.setGeometry(QRect(120, 410, 60, 30))
        self.reset_btn.setText("重置")
        self.reset_btn.clicked.connect(self.reset)

        ################
        self.save_btn.setGeometry(QRect(220, 410, 60, 30))
        self.save_btn.setText("保存")
        self.save_btn.clicked.connect(self.write_file)

        self.exit_btn.setGeometry(QRect(300, 410, 60, 30))
        ...
        self.box_layout.addWidget(self.modify_btn)
